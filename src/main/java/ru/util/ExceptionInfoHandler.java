...
import ru.util.exception.ApplicationException;
import ru.util.exception.ErrorInfo;
...
import static ru.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_MORE_THAN_ONE_VOTE_PER_USER_DAILY = "exception.vote.voteChangingRestriction";

    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            "users_unique_email_idx", EXCEPTION_DUPLICATE_EMAIL,
            "votes_unique_user_added_idx", EXCEPTION_MORE_THAN_ONE_VOTE_PER_USER_DAILY);
    ...
    private ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... details) {
        Throwable rootCause = validator.logAndGetRootCause(log, req, e, logException, errorType);
